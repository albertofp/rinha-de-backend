...
Alberto F. Pluecker albertopluecker@gmail.com https://github.com/albertofp
...
### <span id="get-contagem-pessoas"></span> Count total amount of people in the database (*GetContagemPessoas*)
...
### <span id="get-getall"></span> Get every person in the database (*GetGetall*)
...
### <span id="get-pessoas"></span> Search by term (*GetPessoas*)
...
### <span id="get-pessoas-id"></span> Search person by ID (*GetPessoasID*)
...
### <span id="get-status"></span> Health check (*GetStatus*)
...
### <span id="post-pessoas"></span> Create new person document (*PostPessoas*)
